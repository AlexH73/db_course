...
Установка Beekeeper Studio и запуск Postgres через докер

Обсудили что такое БД и СУБД

Разборали, что такое таблица, строки, столбцы, primary key, нормализация в общих словах: 
[ссылка на таблицу](https://docs.google.com/spreadsheets/d/1qOAIRvWYnuUOYmjveuud_PZhCmyFTBnJtFFlA0FF-8I/edit?gid=0#gid=0)
